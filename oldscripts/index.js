(function() {
    ...
    function prepareEventAndBubblesButtons(elementName) {
        var i,l,elms,nbElmsPerPageHoriz,offset,nbElmsPerPageVert,el,parent;
    ...
    function sortItems() {
        var items = document.querySelectorAll("#common li")
    ...
    function next_gallery(e) {
        var el = e.target,p = el.parentNode.parentNode,childs = p.getElementsByClassName("nav_cont");
        var offset = el.offset + (childs[0].firstElementChild.currentOffset | 0);
    ...
    function prev_gallery(e) {
        var el = e.target,p = el.parentNode.parentNode,childs = p.getElementsByClassName("nav_cont");
        var offset = (childs[0].firstElementChild.currentOffset | 0) - el.offset;
        childs[0].firstElementChild.style.transform = "translateX(-" + offset + "px)";
        childs[0].firstElementChild.currentOffset = offset;
        if(offset === 0) {
            el.classList.add("hidden");
    ...
    function changeGallery(e) {
        var el = e.target,p = el.parentNode.parentNode,childs = p.getElementsByClassName("nav_cont"),elms;
