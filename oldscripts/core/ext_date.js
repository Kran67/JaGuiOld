...
define(['core'], function (Core) {
    ...
    */
    Date.prototype.toString = function (format) {
        ...
        if (typeof format !== Const.STRING) format = String.EMPTY;
        var p = function (s) {
        ...
        function (f) {
            ...
            else if (f === "t") return self.getHours() < 12 ? Core.currentLocale.am.substring(0, 1) : Core.currentLocale.pm.substring(0, 1);
            else if (f === "tt") return self.getHours() < 12 ? Core.currentLocale.am : Core.currentLocale.pm;
    ...
    Date.isDate = function (a) {
        ...
        if (Math.mod(d[2], 4) === 0 && Math.mod(d[2], 100) !== 0 || Math.Mod(d[2], 400) === 0) d[3] = 29;
        else d[3] = 28;
    ...
    Date.dateExists = function (a) {
        var Const = require("types").CONSTANTS;
        if (!a) return false;
        if (typeof a !== Const.STRING) return false;
