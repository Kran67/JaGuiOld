define([], function () {
    ...
    //        c = c.split(String.SPACE);
    //        for (i = 0; i < c.length; i++)
    //            if (cssClass.indexOf(c[i]) === -1) cssClass.add(c[i]);
    ...
    //            c = c.split(String.SPACE);
    //            //cssClass.remove(c);
    //            for (i = 0; i < c.length; i++) cssClass.remove(c[i]);
    //            o.className = cssClass.join(String.SPACE);
    //        }
    //    },
    //    toggle: function (o, c) {
    ...
    //            c = c.split(String.SPACE);
    //            for (i = 0; i < c.length; i++) {
    //                if (cssClass.indexOf(c[i]) > -1) cssClass.remove(c[i]);
    //                else cssClass.add(c[i]);
    //            }
    //            o.className = cssClass.join(String.SPACE);
    //        }
    //    },
    //    containsClass: function (o, c) {
    //        var cssClass = [];
    //        if (!o || !c) return false;
    //        if (o.className.contains(String.SPACE)) cssClass = o.className.split(String.SPACE);
    //        else cssClass.push(o.className);
    //        if (cssClass) return cssClass.indexOf(c) > -1;
    //        return false;
    //    },
    ...
    //    },
    //    removeCSSRule: function (selector, ruleType) {
    //        var rulesIndex = [], i, l;
    //        if (!ruleType) ruleType = $j.types.CSSRuleTypes.STYLE_RULE;
    ...
    //        i = rulesIndex.length;
    //        while (i > 0) {
    //            $j.rtStyle.sheet.deleteRule(rulesIndex[0]);
    //            i--;
    //        }
    //    },
    ...
    //        /*if ((obj.form._loading||obj._loading||obj._HTMLElement===null)&&(CSSProp!==$j.types.jsCSSProperties.ANIMATION)) return;
    //        var r,w;
    //        if ((obj._HTMLElement===null)&&(CSSProp!==$j.types.jsCSSProperties.ANIMATION)) {
    //          obj._HTMLElement=$j.doc.getElementById(obj._internalId);
    //          obj._HTMLElement.jsObj=obj;
    //        }
    //        if (value===null) {
    //          switch (CSSProp) {
    ...
    //                //  obj.style.customNormal.font.toCss(obj._HTMLElement);
    //                //}
    //              }
    //              break;
    ...
    //          }
    //        }
    //        obj._HTMLElement.style[$j.browser.getVendorPrefix(CSSProp)+CSSProp]=value;
    //        // for scaled object only
    //        //if (CSSProp===$j.types.CSSProperties.TRANSFORM) {
    //        //  if (obj.scale.x!==1||obj.scale.y!==1) {
    //        //    r=obj._HTMLElement.getBoundingClientRect();
    //        //    obj._HTMLElement.style.left=obj.left+~~((r.width-obj._HTMLElement.offsetWidth)/2)+"px";
    //        //    obj._HTMLElement.style.top=obj.top+~~((r.height-obj._HTMLElement.offsetHeight)/2)+"px";
    //        //  }
    //        //}*/
    //    },
    ...
    //            break;
    //          case $j.types.vertTextAligns.BOTTOM:
    //            cssValue=~~((obj.height-$j.tools.text.getTextSizes(obj.caption,null,obj._HTMLElement).h)/2)+$j.types.CSSUnits.PX+";";
    //            break;
    //        }
