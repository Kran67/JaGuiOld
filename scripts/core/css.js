...
class Css {
    ...
    //        if (backColor) {
    //            //if(hovered){
    //            //  object.style.hovered.background.style=$j.core.types.brushStyles.SOLID;
    //            //  object.style.hovered.background.color.assign(_colors.parse(css.backgroundColor));
    //            //} else if (pressed){
    //            //  object.style.pressed.background.style=$j.core.types.brushStyles.SOLID;
    //            //  object.style.pressed.background.color.assign(_colors.parse(css.backgroundColor));
    //            //} else {
    //            if (object instanceof $j.classes.Control) {
    //                object.style.normal.background.style = $j.core.types.brushStyles.SOLID;
    ...
    //                object.background.style = $j.core.types.brushStyles.SOLID;
    ...
    //                //if(hovered) object.style.hovered.background.style=$j.core.types.brushStyles.GRADIENT;
    //                //else if (pressed) object.style.pressed.background.style=$j.core.types.brushStyles.GRADIENT;
    //                //else {
    //                if (object instanceof $j.classes.DrawingInfo) object.background.style = $j.core.types.brushStyles.GRADIENT;
    //                else object.style.normal.background.style = $j.core.types.brushStyles.GRADIENT;
    //                //if (firstPass){
    //                //  if(!hovered&&!pressed){
    //                //    if (object.style.hovered) object.style.hovered.background.style=$j.core.types.brushStyles.GRADIENT;
    //                //    if (object.style.pressed) object.style.pressed.background.style=$j.core.types.brushStyles.GRADIENT;
    //                //  }
    //                //}
    //                //}
    //                if (gradient.indexOf("linear") !== -1) { // linear gradient
    //                    //if(hovered) object.style.hovered.background.gradient.style=$j.core.types.gradientStyles.LINEAR;
    //                    //else if (pressed) object.style.pressed.background.gradient.style=$j.core.types.gradientStyles.LINEAR;
    //                    //else {
    //                    if (object instanceof $j.classes.DrawingInfo) object.background.gradient.style = $j.core.types.gradientStyles.LINEAR;
    //                    else object.style.normal.background.gradient.style = $j.core.types.gradientStyles.LINEAR;
    //                    //if (firstPass){
    //                    //  if(!hovered&&!pressed){
    //                    //    if (object.style.hovered) object.style.hovered.background.gradient.style=$j.core.types.gradientStyles.LINEAR;
    //                    //    if (object.style.pressed) object.style.pressed.background.gradient.style=$j.core.types.gradientStyles.LINEAR;
    //                    //  }
    //                    //}
    //                    //}
    //                    gradient = gradient.replace("linear-gradient(", String.EMPTY);
    //                    gradient = gradient.replace("%)", $j.core.types.CSSUnits.PO);
    //                    gradient = $j.core.tools.text.replace(gradient, "transparent", "rgba(0,0,0,0)");
    //                    gradient = $j.core.tools.text.replace(gradient, ", rgb", "|rgb");
    ...
    //                        var colorOffset = gradValues[i].replace(") ", ")|"), color = colorOffset.split("|")[0], offset = +(colorOffset.split("|")[1].replace($j.core.types.CSSUnits.PO, String.EMPTY));
    ...
    //                    //if(hovered) object.style.hovered.background.gradient.setStyle($j.core.types.gradientStyles.RADIAL);
    //                    //else if(pressed) object.style.pressed.background.gradient.setStyle($j.core.types.gradientStyles.RADIAL);
    //                    //else {
    //                    if (object instanceof $j.classes.DrawingInfo) object.background.gradient.style = $j.core.types.gradientStyles.RADIAL;
    //                    else object.style.normal.background.gradient.style = $j.core.types.gradientStyles.RADIAL;
    //                    //if (firstPass){
    //                    //  if(!hovered&&!pressed){
    //                    //    if (object.style.hovered) object.style.hovered.background.gradient.setStyle($j.core.types.gradientStyles.RADIAL);
    //                    //    if (object.style.pressed) object.style.pressed.background.gradient.setStyle($j.core.types.gradientStyles.RADIAL);
    //                    //  }
    //                    //}
    //                    //}
    //                }
    ...
    //                back.style = $j.core.types.brushStyles.BITMAP;
    //                back.bitmapRepeatMode = $j.core.types.bitmapRepeatModes.REPEAT;
    //                back.bitmap.src = $j.core.tools.uri.clean(css.backgroundImage);
    ...
    //                    ret[0][0] = +radius[0].replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                    ret[0][1] = +radius[1].replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                } else {
    //                    radius = +css.borderTopLeftRadius.replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                    ret[0][0] = radius;
    //                    ret[0][1] = radius;
    //                }
    //            }
    ...
    //                    ret[1][0] = +radius[0].replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                    ret[1][1] = +radius[1].replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                } else {
    //                    radius = +css.borderTopRightRadius.replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                    ret[1][0] = radius;
    //                    ret[1][1] = radius;
    //                }
    //            }
    ...
    //                    ret[2][0] = +radius[0].replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                    ret[2][1] = +radius[1].replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                } else {
    //                    radius = +css.borderBottomLeftRadius.replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                    ret[2][0] = radius;
    //                    ret[2][1] = radius;
    //                }
    //            }
    ...
    //                    ret[3][0] = +radius[0].replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                    ret[3][1] = +radius[1].replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                } else {
    //                    radius = +css.borderBottomRightRadius.replace($j.core.types.CSSUnits.PX, String.EMPTY).replace($j.core.types.CSSUnits.PO, String.EMPTY);
    //                    ret[3][0] = radius;
    //                    ret[3][1] = radius;
    //                }
    //            }
    ...
    //            //  object.style.hovered.border.style=$j.core.types.brushStyles.SOLID;
    //            //} else if (pressed) {
    //            //  object.style.pressed.border.color.assign(_colors.parse(c));
    //            //  object.style.pressed.border.style=$j.core.types.brushStyles.SOLID;
    //            //} else {
    //            //if (firstPass){
    //            //  if(object.style.hovered) {
    //            //    object.style.hovered.border.color.assign(_colors.parse(c));
    ...
    //            object.border.style = $j.core.types.brushStyles.SOLID;
    //            //}
    //        }
    //        if (css.borderLeftWidth || css.borderTopWidth || css.borderRightWidth || css.borderBottomWidth) {
    //            if (css.borderLeftWidth) w = +css.borderLeftWidth.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //            else if (css.borderTopWidth) w = +css.borderTopWidth.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //            else if (css.borderRightWidth) w = +css.borderRightWidth.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //            else if (css.borderBottomWidth) w = +css.borderBottomWidth.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //            object.sides = $j.core.types.sides.NONE;
    //            if (css.borderLeftWidth) object.sides |= $j.core.types.sides.LEFT;
    //            if (css.borderTopWidth) object.sides |= $j.core.types.sides.TOP;
    //            if (css.borderRightWidth) object.sides |= $j.core.types.sides.RIGHT;
    //            if (css.borderBottomWidth) object.sides |= $j.core.types.sides.BOTTOM;
    //            if (isNaN(w)) w = 0;
    ...
    //        }
    //        if (css.outlineWidth) {
    //            w = +css.outlineWidth.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //            if (isNaN(w)) w = 0;
    ...
    //                //} else {
    //                object.shadowOffsetX = +shadow[0].replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //                object.shadowOffsetY = +shadow[1].replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //                object.shadowBlur = +shadow[2].replace($j.core.types.CSSUnits.PX, String.EMPTY);
    ...
    //                var shadow = $j.core.tools.replace(css.textShadow, ", ", ",").split(String.SPACE);
    //                object.shadowOffsetX = +shadow[0].replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //                object.shadowOffsetY = +shadow[1].replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //                object.shadowBlur = +shadow[2].replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //                object.shadowColor.assign(_colors.parse(shadow[3]));
    ...
    //        if (css.paddingLeft) object.padding.rect.left = +css.paddingLeft.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.paddingTop) object.padding.rect.top = +css.paddingTop.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.paddingRight) object.padding.rect.right = +css.paddingRight.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.paddingBottom) object.padding.rect.bottom = +css.paddingBottom.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //    },
    //    getMargins: function (className, object) {
    //        var css = $j.css[className];
    //        if (!css) return;
    //        if (!object.margin) return;
    //        if (css.marginLeft) object.margin.rect.left = +css.marginLeft.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.marginTop) object.margin.rect.top = +css.marginTop.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.marginRight) object.margin.rect.right = +css.marginRight.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.marginBottom) object.margin.rect.bottom = +css.marginBottom.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //    },
    ...
    //        else if (object instanceof $j.classes.DrawingInfo) style = object;
    //        if (!css) return;
    //        if (css.width && css.width !== String.EMPTY) w = ~~css.width.replace($j.core.types.CSSUnits.PX, String.EMPTY) + (style ? style.borderWidth * 2 : 0);
    //        if (css.height && css.height !== String.EMPTY) h = ~~css.height.replace($j.core.types.CSSUnits.PX, String.EMPTY) + (style ? style.borderWidth * 2 : 0);
    //        if (css.left && css.left !== String.EMPTY) l = ~~css.left.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.top && css.top !== String.EMPTY) t = ~~css.top.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.right && css.right !== String.EMPTY) r = ~~css.right.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (css.bottom && css.bottom !== String.EMPTY) b = ~~css.bottom.replace($j.core.types.CSSUnits.PX, String.EMPTY);
    //        if (w) object.width = w;
    ...
    //        if (css.fontSize) {
    //            if (css.fontSize.endsWith($j.core.types.CSSUnits.PO) || css.fontSize.endsWith($j.core.types.CSSUnits.REM)) {
    //                font.size = parseFloat(css.fontSize);
    //                if (css.fontSize.endsWith($j.core.types.CSSUnits.PO)) font.sizeUnit = $j.core.types.CSSUnits.PO;
    //                else font.sizeUnit = $j.core.types.CSSUnits.REM;
    //            } else {
    //                font.size = parseFloat(css.fontSize);
    ...
    //            font.brush.style = $j.core.types.brushStyles.SOLID;
    //        }
    //    },
    ...
    //            o.oHtml.style.borderRadius = o.radius + $j.core.types.CSSUnits.PX;
    //        }
    //    },
    ...
    //                if (i > 0) b += ", ";
    //                b += colorstops[i].color.toARGBString() + String.SPACE + (colorstops[i].offset * 100) + $j.core.types.CSSUnits.PO;
    //            }
    //            b += ")";
    ...
    //            g.setAttribute("x1", (o[type].gradient.startPosition.x * 100) + $j.core.types.CSSUnits.PO);
    //            g.setAttribute("y1", (o[type].gradient.startPosition.y * 100) + $j.core.types.CSSUnits.PO);
    //            g.setAttribute("x2", (o[type].gradient.stopPosition.x * 100) + $j.core.types.CSSUnits.PO);
    //            g.setAttribute("y2", (o[type].gradient.stopPosition.y * 100) + $j.core.types.CSSUnits.PO);
    //            for (var i = 0, l = colorstops.length; i < l; i++) {
    //                var stop = document.createElementNS("http://www.w3.org/2000/svg", "stop");
    //                stop.setAttribute('offset', (colorstops[i].offset * 100) + $j.core.types.CSSUnits.PO);
    ...
    static isCSSRuleExist(selector, ruleType) {
        !ruleType ? ruleType = core.types.CSSRULEcore.types.STYLE_RULE : 1;
    ...
    static removeCSSRule(selector, ruleType) {
        ...
        !ruleType ? ruleType = CSSRULEcore.types.STYLE_RULE : 1;
    ...
    //        }
    //        if (!$j.core.tools.valueInSet(flags, $j.core.types.CSSSelectorsFlags)) flags = $j.core.types.CSSSelectorsFlags.START;
    //        for (var x = styles.length - 1; x > -1; x--) {
    //            if (title) {
    //                if (styles[x].href) {
    //                    styleName = $j.core.tools.uri.extractFileName(styles[x].href).split(".").first();
    ...
    //                        if (flags === $j.core.types.CSSSelectorsFlags.START) selectorFounded = classes[i].selectorText.startsWith(selector);
    //                        else if (flags === $j.core.types.CSSSelectorsFlags.CONTAINS) selectorFounded = classes[i].selectorText.indexOf(selector) > -1;
    //                        else if (flags === $j.core.types.CSSSelectorsFlags.ENDS) selectorFounded = classes[i].selectorText.endsWith(selector);
    ...
    //        /*if ((obj.form.loading||obj.loading||obj.HTMLElement===null)&&(CSSProp!==$j.core.types.jsCSSProperties.ANIMATION)) return;
    //        var r,w;
    //        if ((obj.HTMLElement===null)&&(CSSProp!==$j.core.types.jsCSSProperties.ANIMATION)) {
    //          obj.HTMLElement=$j.doc.getElementById(obj._internalId);
    //          obj.HTMLElement.jsObj=obj;
    //        }
    //        if (value===null) {
    //          switch (CSSProp) {
    //            case $j.core.types.jsCSSProperties.LEFT:
    //              if (obj.align===$j.core.types.aligns.MOSTRIGHT||
    //                  obj.align===$j.core.types.aligns.RIGHT||
    //                  obj.align===$j.core.types.aligns.TOPRIGHT||
    //                  obj.align===$j.core.types.aligns.BOTTOMRIGHT) return;
    //              if (obj.align===$j.core.types.aligns.HORZCENTER||
    //                  obj.align===$j.core.types.aligns.CENTER) value="50%";
    //              else value=obj.left+$j.core.types.CSSUnits.PX;
    //              break;
    //            case $j.core.types.jsCSSProperties.TOP:
    //              if (obj.align===$j.core.types.aligns.MOSTBOTTOM||
    //                  obj.align===$j.core.types.aligns.BOTTOM||
    //                  obj.align===$j.core.types.aligns.BOTTOMLEFT||
    //                  obj.align===$j.core.types.aligns.BOTTOMRIGHT) return;
    //              if (obj.align===$j.core.types.aligns.VERTCENTER||
    //                  obj.align===$j.core.types.aligns.CENTER) value="50"+$j.core.types.CSSUnits.PO;
    //              else value=obj.top+$j.core.types.CSSUnits.PX;
    //              break;
    //            case $j.core.types.jsCSSProperties.RIGHT:
    //              if (obj.align===$j.core.types.aligns.MOSTLEFT||
    //                  obj.align===$j.core.types.aligns.LEFT||
    //                  obj.right===-0xFFFF) return;
    //              value=obj.right+$j.core.types.CSSUnits.PX;
    //              break;
    //            case $j.core.types.jsCSSProperties.BOTTOM:
    //              if (obj.bottom===-0xFFFF) return;
    //              value=obj.bottom+$j.core.types.CSSUnits.PX;
    //              break;
    //            case $j.core.types.jsCSSProperties.DISPLAY:
    //              if (obj.visible) value="block";
    //              else value="none";
    //              break;
    //            case $j.core.types.jsCSSProperties.WIDTH:
    //              if (obj.align===$j.core.types.aligns.MOSTTOP||
    //                  obj.align===$j.core.types.aligns.TOP||
    //                  obj.align===$j.core.types.aligns.MOSTBOTTOM||
    //                  obj.align===$j.core.types.aligns.BOTTOM||
    //                  obj.align===$j.core.types.aligns.CLIENT||
    //                  obj.align===$j.core.types.aligns.VERTCENTER) value="auto";
    //              else if (obj instanceof $j.classes.GraphicControl) value=(obj.width-obj.borderWidth*2)+$j.core.types.CSSUnits.PX;
    //              else if (obj instanceof $j.classes.ThemedControl) {
    //                r=this.getCSSValue(obj.themeAndClassName,"border-left");
    //                if (r!==null) w=~~(r.replace($j.core.types.CSSUnits.PX,String.EMPTY));
    //                r=this.getCSSValue(obj.themeAndClassName,"border-right");
    //                if (r!==null) w+=~~(r.replace($j.core.types.CSSUnits.PX,String.EMPTY));
    //                value=(obj.width+w)+$j.core.types.CSSUnits.PX;
    //              } else value=obj.width+$j.core.types.CSSUnits.PX;
    //              break;
    //            case $j.core.types.jsCSSProperties.HEIGHT:
    //              if (obj.align===$j.core.types.aligns.MOSTLEFT||
    //                  obj.align===$j.core.types.aligns.LEFT||
    //                  obj.align===$j.core.types.aligns.MOSTRIGHT||
    //                  obj.align===$j.core.types.aligns.RIGHT||
    //                  obj.align===$j.core.types.aligns.CLIENT||
    //                  obj.align===$j.core.types.aligns.HORZCENTER) value="auto";
    //              else if (obj instanceof $j.classes.GraphicControl) value=(obj.height-obj.borderWidth*2)+$j.core.types.CSSUnits.PX;
    //              else if (obj instanceof $j.classes.ThemedControl) {
    //                r=this.getCSSValue(obj.themeAndClassName,"border-top");
    //                if (r!==null) w=~~(r.replace($j.core.types.CSSUnits.PX,String.EMPTY));
    //                r=this.getCSSValue(obj.themeAndClassName,"border-bottom");
    //                if (r!==null) w+=~~(r.replace($j.core.types.CSSUnits.PX,String.EMPTY));
    //                value=(obj.height+w)+$j.core.types.CSSUnits.PX;
    //              } else value=obj.height+$j.core.types.CSSUnits.PX;
    //              break;
    //            case $j.core.types.jsCSSProperties.TRANSFORM:
    //              value=String.EMPTY;
    //              if (obj.rotateAngle!==0) value+=" rotate("+obj.rotateAngle+"deg)";
    //              if (obj.scale.x!==1||obj.scale.y!==1) value+=" scale("+obj.scale.x+","+obj.scale.y+")";
    //              break;
    //            case $j.core.types.jsCSSProperties.TRANSFORMORIGIN:
    //              value=obj.rotateCenter.x+$j.core.types.CSSUnits.PO+String.SPACE+obj.rotateCenter.y+$j.core.types.CSSUnits.PO;
    //              break;
    //            case $j.core.types.jsCSSProperties.PADDING:
    //              if (!obj.padding.empty) value=obj.padding.toCSS();
    //              else value=String.EMPTY;
    //              break;
    //            case $j.core.types.jsCSSProperties.MARGIN:
    //              var offset=0;
    //              if (obj instanceof $j.classes.GraphicControl) offset=obj.borderWidth;
    //              if (obj.align===$j.core.types.aligns.CENTER) {
    //                value="-"+(~~(obj.height/2)+obj.margin.top+offset)+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.right+$j.core.types.CSSUnits.PX+String.SPACE+
    //                      obj.margin.bottom+$j.core.types.CSSUnits.PX+" -"+(~~(obj.width/2)+obj.margin.left+offset)+$j.core.types.CSSUnits.PX;
    //              } else if (obj.align===$j.core.types.aligns.HORZCENTER) {
    //                value=obj.margin.top+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.right+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.bottom+
    //                      $j.core.types.CSSUnits.PX+" -"+(~~(obj.width/2)+obj.margin.left+offset)+$j.core.types.CSSUnits.PX;
    //              } else if (obj.align===$j.core.types.aligns.VERTCENTER) {
    //                value="-"+(~~(obj.height/2)+obj.margin.top+offset)+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.right+$j.core.types.CSSUnits.PX+String.SPACE+
    //                      obj.margin.bottom+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.left+$j.core.types.CSSUnits.PX;
    //              }
    //              else if (!obj.margin.empty) value=obj.margin.toCSS();
    //              else value=String.EMPTY;
    //              break;
    //            case $j.core.types.jsCSSProperties.FONT:
    ...
    //              }
    //              break;
    //            case $j.core.types.jsCSSProperties.COLOR:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    //              if (obj instanceof $j.classes.ThemedControl) {
    //                //if (!obj.style.customNormal.font.empty) {
    ...
    //              }
    //              break;
    //            case $j.core.types.jsCSSProperties.BACKGROUND:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    //              if (obj instanceof $j.classes.GraphicControl) {
    //                if (obj.background.style===$j.core.types.brushStyles.GRADIENT) {
    //                  if (obj.background.gradient.style===$j.core.types.gradientStyles.LINEAR) {
    ...
    //                  } else {
    //                  }
    //                } else if (obj.background.style===$j.core.types.brushStyles.BITMAP) {
    //                }
    //              } else {
    //              }
    //              break;
    //            case $j.core.types.jsCSSProperties.BACKGROUNDCOLOR:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    //              if (obj instanceof $j.classes.GraphicControl) {
    //                switch (obj.background.style) {
    //                  case $j.core.types.brushStyles.SOLID:
    //                    value=obj.background.color.toARGBString();
    //                    break;
    //                  //case $j.core.types.brushStyles.GRADIENT:
    //                  //  value=$j.browser.("linear-gradient")+"linear-gradient("
    //                  //  break;
    //                  //case $j.core.types.brushStyles.BITMAP:
    //                  //  break;
    //                }
    //              } else {
    //              }
    //              //value=
    //              break;
    //            case $j.core.types.jsCSSProperties.BACKGROUNDREPEAT:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    //              break;
    //            case $j.core.types.jsCSSProperties.BACKGROUNDATTACHMENT:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    //              break;
    //            case $j.core.types.jsCSSProperties.BACKGROUNDIMAGE:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    ...
    //              }
    //              break;
    //            case $j.core.types.jsCSSProperties.BACKGROUNDSIZE:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    //              break;
    //            case $j.core.types.jsCSSProperties.BORDER:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    //              if (obj instanceof $j.classes.GraphicControl) {
    //                if (obj.border.style!==$j.core.types.brushStyles.NONE) {
    //                  value=obj.borderWidth+$j.core.types.CSSUnits.PX+String.SPACE;
    ...
    //              }
    //              break;
    //            case $j.core.types.jsCSSProperties.BORDERRADIUS:
    //              if (obj.DOMElement===$j.core.types.HTMLElements.CANVAS) return;
    ...
    //              }
    //              break;
    //            case $j.core.types.jsCSSProperties.MINWIDTH:
    //              break;
    //            case $j.core.types.jsCSSProperties.MAXWIDTH:
    //              break;
    //            case $j.core.types.jsCSSProperties.MINHEIGHT:
    //              break;
    //            case $j.core.types.jsCSSProperties.MAXHEIGHT:
    //              break;
    //            case $j.core.types.jsCSSProperties.BOXSHADOW:
    //              if (obj instanceof $j.classes.ThemedControl) {
    ...
    //                //    value=r.shadowOffsetX+$j.core.types.CSSUnits.PX+String.SPACE+r.shadowOffsetY+$j.core.types.CSSUnits.PX+String.SPACE+r.shadowBlur+$j.core.types.CSSUnits.PX+String.SPACE+r.shadowColor.toARGBString();
    //                //  }
    //                //  if (obj.DOMElement===$j.core.types.HTMLElements.LABEL) {
    //                //    CSSProp=$j.core.types.jsCSSProperties.TEXTSHADOW;
    //                //  } else {
    //                //    CSSProp=$j.core.types.jsCSSProperties.BOXSHADOW;
    //                //  }
    //                //}
    //              } else if (obj instanceof $j.classes.GraphicControl) {
    //                if (!obj.shadowColor.equals(_colors.TRANSPARENT)||obj.shadowBlur!==0) {
    //                  value=obj.shadowOffsetX+$j.core.types.CSSUnits.PX+String.SPACE+obj.shadowOffsetY+$j.core.types.CSSUnits.PX+String.SPACE+obj.shadowBlur+$j.core.types.CSSUnits.PX+String.SPACE+obj.shadowColor.toARGBString();
    //                }
    //                CSSProp=$j.core.types.jsCSSProperties.BOXSHADOW;
    //              }
    //              break;
    //            case $j.core.types.jsCSSProperties.OPACITY:
    //              if (obj.opacity<=1) value=obj.opacity;
    //              break;
    //            case $j.core.types.jsCSSProperties.ZINDEX:
    //              break;
    //            //case $j.core.types.jsCSSProperties.CURSOR:
    //            //  value=obj.form.getThemeName()+"_"+obj.cursor;
    //            //  break;
    //            case $j.core.types.jsCSSProperties.TEXTALIGN:
    //              if (!(obj instanceof $j.classes.CaptionControl)) return;
    //              value=obj.horizAlign;
    //              //switch (obj.horizAlign) {
    //              //  case $j.core.types.textAligns.LEFT:
    //              //    value="left";
    //              //    break;
    //              //  case $j.core.types.textAligns.CENTER:
    //              //    value="center";
    //              //    break;
    //              //  case $j.core.types.textAligns.RIGHT:
    //              //    value="right";
    //              //    break;
    //              //};
    //              break;
    //            case $j.core.types.jsCSSProperties.LINEHEIGHT:
    //              if (!(obj instanceof $j.classes.CaptionControl)) return;
    //              switch (obj.vertAlign) {
    //                case $j.core.types.vertTextAligns.TOP:
    //                  value=String.EMPTY;
    //                  break;
    //                case $j.core.types.vertTextAligns.MIDDLE:
    //                  value=obj.height+$j.core.types.CSSUnits.PX;
    //                  break;
    //                case $j.core.types.vertTextAligns.BOTTOM:
    //                  value=((obj.height*2)-$j.core.tools.font.getTextHeight("°_").H)+$j.core.types.CSSUnits.PX;
    //                  break;
    //              };
    //              break;
    //            case $j.core.types.jsCSSProperties.OVERFLOW:
    //              if (obj.clipChilds) value="hidden";
    //              break;
    //            case $j.core.types.jsCSSProperties.ANIMATION:
    ...
    //              } else return;
    //              break;
    //            case $j.core.types.jsCSSProperties.ANIMATIONSTATE:
    ...
    //        //if (CSSProp===$j.core.types.CSSProperties.TRANSFORM) {
    ...
    //          obj.align!==$j.core.types.aligns.RIGHT&&
    //          obj.align!==$j.core.types.aligns.TOPRIGHT&&
    //          obj.align!==$j.core.types.aligns.BOTTOMRIGHT) {
    //        if (obj.align===$j.core.types.aligns.HORZCENTER||obj.align===$j.core.types.aligns.CENTER) cssValue="50"+$j.core.types.CSSUnits.PO+";";
    //        else cssValue=obj.left+$j.core.types.CSSUnits.PX+";";
    //        cssRule[$j.core.types.CSSProperties.LEFT]=cssValue;
    //      }
    //      // top
    //      if (obj.align!==$j.core.types.aligns.MOSTBOTTOM&&
    //          obj.align!==$j.core.types.aligns.BOTTOM&&
    //          obj.align!==$j.core.types.aligns.BOTTOMLEFT&&
    //          obj.align!==$j.core.types.aligns.BOTTOMRIGHT) {
    //        if (obj.align===$j.core.types.aligns.VERTCENTER||obj.align===$j.core.types.aligns.CENTER) cssValue="50"+$j.core.types.CSSUnits.PO+";";
    //        else cssValue=obj.top+$j.core.types.CSSUnits.PX+";";
    //        cssRule[$j.core.types.CSSProperties.TOP]=cssValue;
    //      }
    //      // right
    //      if (obj.align!==$j.core.types.aligns.MOSTLEFT&&
    //          obj.align!==$j.core.types.aligns.LEFT&&
    //          obj.right!==-0xFFFF) {
    //        cssRule[$j.core.types.CSSProperties.RIGHT]=obj.right+$j.core.types.CSSUnits.PX+";";
    //      }
    //      // bottom
    //      if (obj.bottom!==-0xFFFF) {
    //        cssRule[$j.core.types.CSSProperties.BOTTOM]=obj.bottom+$j.core.types.CSSUnits.PX+";";
    //      }
    //      // display
    //      if (obj.visible&&!obj.loading) cssValue="block;";
    //      else cssValue="none;";
    //      cssRule[$j.core.types.CSSProperties.DISPLAY]=cssValue;
    //      // width
    //      if (obj.align===$j.core.types.aligns.MOSTTOP||
    //          obj.align===$j.core.types.aligns.TOP||
    //          obj.align===$j.core.types.aligns.MOSTBOTTOM||
    //          obj.align===$j.core.types.aligns.BOTTOM||
    //          obj.align===$j.core.types.aligns.CLIENT||
    //          obj.align===$j.core.types.aligns.VERTCENTER) cssValue="auto;";
    //      else if (obj instanceof $j.classes.GraphicControl) cssValue=(obj.width-obj.borderWidth*2)+$j.core.types.CSSUnits.PX+";";
    //      else if (obj instanceof $j.classes.ThemedControl) {
    //        r=this.getCSSValue(obj.themeAndClassName,$j.core.types.CSSProperties.BORDERLEFTWIDTH,$j.core.types.CSSSelectorsFlags.CONTAINS);
    //        if (r!==null) w=~~(r.replace($j.core.types.CSSUnits.PX,String.EMPTY));
    //        r=this.getCSSValue(obj.themeAndClassName,$j.core.types.CSSProperties.BORDERRIGHTWIDTH,$j.core.types.CSSSelectorsFlags.CONTAINS);
    //        if (r!==null) w+=~~(r.replace($j.core.types.CSSUnits.PX,String.EMPTY));
    //        cssValue=(obj.width-w)+$j.core.types.CSSUnits.PX+";";
    //      } else cssValue=obj.width+$j.core.types.CSSUnits.PX+";";
    //      cssRule[$j.core.types.CSSProperties.WIDTH]=cssValue;
    //      // height
    //      if (obj.align===$j.core.types.aligns.MOSTLEFT||
    //          obj.align===$j.core.types.aligns.LEFT||
    //          obj.align===$j.core.types.aligns.MOSTRIGHT||
    //          obj.align===$j.core.types.aligns.RIGHT||
    //          obj.align===$j.core.types.aligns.CLIENT||
    //          obj.align===$j.core.types.aligns.HORZCENTER) cssValue="auto;";
    //      else if (obj instanceof $j.classes.GraphicControl) cssValue=(obj.height-obj.borderWidth*2)+$j.core.types.CSSUnits.PX+";";
    //      else if (obj instanceof $j.classes.ThemedControl) {
    //        r=this.getCSSValue(obj.themeAndClassName,$j.core.types.CSSProperties.BORDERTOPWIDTH,$j.core.types.CSSSelectorsFlags.CONTAINS);
    //        if (r!==null) w=~~(r.replace($j.core.types.CSSUnits.PX,String.EMPTY));
    //        r=this.getCSSValue(obj.themeAndClassName,$j.core.types.CSSProperties.BORDERBOTTOMWIDTH,$j.core.types.CSSSelectorsFlags.CONTAINS);
    //        if (r!==null) w+=~~(r.replace($j.core.types.CSSUnits.PX,String.EMPTY));
    //        cssValue=(obj.height-w)+$j.core.types.CSSUnits.PX+";";
    //      } else cssValue=obj.height+$j.core.types.CSSUnits.PX+";";
    //      cssRule[$j.core.types.CSSProperties.HEIGHT]=cssValue;
    //      // transform
    //      cssValue=String.EMPTY;
    //      if (obj.rotateAngle!==0) cssValue=$j.core.types.CSSProperties.ROTATE+"("+obj.rotateAngle+"deg)";
    //      if (obj.scale.x!==1||obj.scale.y!==1) cssValue+=String.SPACE+$j.core.types.CSSProperties.SCALE+"("+obj.scale.x+","+obj.scale.y+")";
    //      if (cssValue!==String.EMPTY) cssRule[$j.browser.getVendorPrefix($j.core.types.CSSProperties.TRANSFORM)+$j.core.types.CSSProperties.TRANSFORM]=cssValue+";";
    //      // transformorigin
    //      if (obj.rotateCenter.x!==0||obj.rotateCenter.y!==0) {
    //        cssValue=obj.rotateCenter.x+$j.core.types.CSSUnits.PO+String.SPACE+obj.rotateCenter.y+$j.core.types.CSSUnits.PO+";";
    //        cssRule[$j.browser.getVendorPrefix($j.core.types.CSSProperties.TRANSFORMORIGIN)+$j.core.types.CSSProperties.TRANSFORMORIGIN]=cssValue;
    //      }
    //      // padding
    //      if (!obj.padding.empty) cssRule[$j.core.types.CSSProperties.PADDING]=obj.padding.toCSS()+";";
    //      // margin
    //      cssValue=String.EMPTY;
    //      offset=0;
    //      //if (obj instanceof $j.classes.GraphicControl) value=obj.borderWidth;
    //      if (obj.align===$j.core.types.aligns.CENTER) {
    //        cssValue="-"+(~~(obj.height/2)+obj.margin.top+offset)+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.right+$j.core.types.CSSUnits.PX+
    //              String.SPACE+obj.margin.bottom+$j.core.types.CSSUnits.PX+" -"+(~~(obj.width/2)+obj.margin.left+offset)+$j.core.types.CSSUnits.PX+";";
    //      } else if (obj.align===$j.core.types.aligns.HORZCENTER) {
    //        cssValue=obj.margin.top+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.right+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.bottom+
    //              $j.core.types.CSSUnits.PX+" -"+(~~(obj.width/2)+obj.margin.left+offset)+$j.core.types.CSSUnits.PX+";";
    //      } else if (obj.align===$j.core.types.aligns.VERTCENTER) {
    //        cssValue=(~~(obj.height/2)+obj.margin.top+offset)+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.right+$j.core.types.CSSUnits.PX+
    //              String.SPACE+obj.margin.bottom+$j.core.types.CSSUnits.PX+String.SPACE+obj.margin.left+$j.core.types.CSSUnits.PX+";";
    //      }
    //      else if (!obj.margin.empty) cssValue=obj.margin.toCSS()+";";
    //      if (cssValue!==String.EMPTY) cssRule[$j.core.types.CSSProperties.MARGIN]=cssValue;
    //      // font
    //      if (obj instanceof $j.classes.ThemedControl) {
    //        //if (!obj.style.customNormal.font.empty) {
    //        //  cssValue=obj.style.customNormal.font.toCssString();
    //        //  cssRule[$j.core.types.CSSProperties.FONT]=cssValue;
    //        //}
    //      }
    //      // color
    //      if (obj.DOMElement!==$j.core.types.HTMLElements.CANVAS) {
    //        if (obj instanceof $j.classes.ThemedControl) {
    //          //if (!obj.style.customNormal.font.empty) {
    //          //  cssValue=obj.style.customNormal.font.brush.color.toARGBString()+";";
    //          //  cssRule[$j.core.types.CSSProperties.COLOR]=cssValue;
    //          //}
    //        }
    //      }
    //      // background
    ...
    //          if (obj.background.style===$j.core.types.brushStyles.GRADIENT) {
    //            if (obj.background.gradient.style===$j.core.types.gradientStyles.LINEAR) {
    //              cssValue=$j.browser.getVendorPrefix($j.core.types.CSSProperties.LINEARGRADIENT)+$j.core.types.CSSProperties.LINEARGRADIENT+"(";
    //              // top
    //              if (obj.background.gradient.stopPosition.x===0&&obj.background.gradient.stopPosition.y===1) {
    //                cssValue+=$j.core.types.CSSProperties.TOP+", ";
    //              } else if (obj.background.gradient.stopPosition.x===1&&obj.background.gradient.stopPosition.y===0) {
    //                cssValue+=$j.core.types.CSSProperties.LEFT+", ";
    //              } else {
    ...
    //              }
    //              for (var i=0,l=obj.background.gradient.items.length;i<l;i++) {
    //                cssValue+=obj.background.gradient.items[i].color.toARGBString()+String.SPACE+(obj.background.gradient.items[i].offset*100)+$j.core.types.CSSUnits.PO;
    //                if (i<l-1) cssValue+=", ";
    //              }
    //              cssValue+=");";
    //            } else {
    ...
    //        }
    //
    //        if (cssValue!==String.EMPTY) cssRule[$j.core.types.CSSProperties.BACKGROUND]=cssValue;
    //      }
    //      // backgroundcolor
    //      cssValue=String.EMPTY;
    //      if (obj.DOMElement!==$j.core.types.HTMLElements.CANVAS) {
    ...
    //        } else {
    //        }
    //        if (cssValue!==String.EMPTY) cssRule[$j.core.types.CSSProperties.BACKGROUNDCOLOR]=cssValue;
    //      }
    //      // backgroundrepeat
    //      if (obj.DOMElement!==$j.core.types.HTMLElements.CANVAS) {
    //      }
    ...
    //            cssRule[$j.core.types.CSSProperties.BACKGROUNDIMAGE]=cssValue;
    //          } else return;
    //        }
    //      }
    //      // backgroundsize
    ...
    //        if (obj instanceof $j.classes.GraphicControl) {
    //          if (obj.border.style!==$j.core.types.brushStyles.NONE) {
    //            cssValue=obj.borderWidth+$j.core.types.CSSUnits.PX+String.SPACE;
    //            switch (obj.border.style) {
    //              case $j.core.types.brushStyles.SOLID:
    ...
    //            cssValue+=";";
    //          }
    //          cssRule[$j.core.types.CSSProperties.BORDER]=cssValue;
    //        } else {
    //        }
    //      }
    //      // borderradius
    ...
    //                String.SPACE+obj.bordersRadius.bottomRight.y+obj.bordersRadius.cssUnit+String.SPACE+obj.bordersRadius.bottomLeft.y+obj.bordersRadius.cssUnit;
    //          cssValue+=";";
    //          cssRule[$j.core.types.CSSProperties.BORDERRADIUS]=cssValue;
    //        } else {
    //        }
    //      }
    //      // minwidth
    ...
    //        //  r=obj.style.customNormal.back;
    //        //  if (!r.shadowColor.equals(_colors.TRANSPARENT)||r.shadowBlur!==0) {
    //        //    cssValue=r.shadowOffsetX+$j.core.types.CSSUnits.PX+String.SPACE+r.shadowOffsetY+$j.core.types.CSSUnits.PX+String.SPACE+r.shadowBlur+$j.core.types.CSSUnits.PX+
    //        //          String.SPACE+r.shadowColor.toARGBString()+";";
    //        //    if (obj.DOMElement===$j.core.types.HTMLElements.LABEL) {
    //        //      cssRule[$j.core.types.CSSProperties.TEXTSHADOW]=cssValue;
    //        //    } else {
    //        //      cssRule[$j.core.types.CSSProperties.BOXSHADOW]=cssValue;
    //        //    }
    //        //  }
    //        //}
    //      } else if (obj instanceof $j.classes.GraphicControl) {
    //        if (!obj.shadowColor.equals(_colors.TRANSPARENT)||obj.shadowBlur!==0) {
    //          cssValue=obj.shadowOffsetX+$j.core.types.CSSUnits.PX+String.SPACE+obj.shadowOffsetY+$j.core.types.CSSUnits.PX+String.SPACE+obj.shadowBlur+
    //                $j.core.types.CSSUnits.PX+String.SPACE+obj.shadowColor.toARGBString()+";";
    //          cssRule[$j.core.types.CSSProperties.BOXSHADOW]=cssValue;
    //        }
    //      }
    //      // opacity
    //      if (obj.opacity<1) cssRule[$j.core.types.CSSProperties.OPACITY]=obj.opacity+";";
    //      // zindex
    //      // textalign
    ...
    //        //    break;
    //        //};
    //        cssRule[$j.core.types.CSSProperties.TEXTALIGN]=obj.horizAlign+";";
    //      }
    //      // lineheight
    ...
    //            break;
    //          case $j.core.types.vertTextAligns.MIDDLE:
    //            cssValue=obj.height+$j.core.types.CSSUnits.PX+";";
    //            break;
    //          case $j.core.types.vertTextAligns.BOTTOM:
    //            cssValue=~~((obj.height-$j.core.tools.text.getTextSizes(obj.caption,null,obj.HTMLElement).h)/2)+$j.core.types.CSSUnits.PX+";";
    //            break;
    //        }
    //        cssRule[$j.core.types.CSSProperties.LINEHEIGHT]=cssValue;
    //      }
    //      // overflow
    //      if (obj.clipChilds) cssRule[$j.core.types.CSSProperties.OVERFLOW]="hidden;";
    //      // animation
    //      //if (obj instanceof $j.classes.Animation) {
    //      //  value=obj.toCSS();
    //      //  obj=obj.owner;
    ...
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.LEFT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.TOP);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.RIGHT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BOTTOM);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.DISPLAY);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.WIDTH);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.HEIGHT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.TRANSFORM);
    //        //this.updateInlineCSS(obj,$j.core.types.CSSProperties.TRANSFORMORIGIN);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.PADDING);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.MARGIN);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.FONT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.COLOR);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BACKGROUND);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BACKGROUNDCOLOR);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BACKGROUNDREPEAT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BACKGROUNDATTACHMENT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BACKGROUNDIMAGE);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BACKGROUNDPOSITION);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BACKGROUNDSIZE);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.TEXTALIGN);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BORDER);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.BORDERRADIUS);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.MINWIDTH);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.MAXWIDTH);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.MINHEIGHT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.MAXHEIGHT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.SHADOW);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.OPACITY);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.ZINDEX);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.LINEHEIGHT);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.OVERFLOW);
    //        this.updateInlineCSS(obj, $j.core.types.CSSProperties.ANIMATION);
    //    },
