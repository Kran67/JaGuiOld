...
class BatteryIndicator extends Control {
    ...
    constructor(owner, props) {
        ...
        if (owner) {
            super(owner, props);
            core.private(this, {
                showLegend: props.hasOwnProperty('showLegend') ? props.showLegend : !1,
                showPercent: props.hasOwnProperty('showPercent') ? props.showPercent : !1,
                battery: null,
                baseWidth: 120,
                baseHeight: 230,
                baseFluidHeight: 190
    ...
    //#region showLegend
    get showLegend() {
        return core.private(this).showLegend;
    }
    ...
    //#region showPercent
    get showPercent() {
        return core.private(this).showPercent;
    }
