...
const Slider = (() => {
    ...
    class Slider extends ThemedControl {
        ...
        constructor(owner, props) {
            ...
            if (owner) {
                ...
                Tools.addPropertyFromEnum({
                    ...
                    forceUpdate: true,
                    variable: priv,
                    value: props.hasOwnProperty("mode")?props.orientation:SLIDERMODES.NORMAL
                });
                this.hitTest = true;
                priv.showValues = false;
                Tools.addPropertyFromEnum({
                    component: this,
                    ...
                    forceUpdate: true,
                    variable: priv,
                    value: props.hasOwnProperty("toolTipsPosition")?props.orientation:Types.ANCHORS.TOP
                });
                priv.decimalPrecision = 0;
        ...
        //#endregion getFirstValue
        //#region getLastValue
        getLastValue() {
            return internal(this).rightInput.valueAsNumber;
        }
        //#endregion getLastValue
        //#endregion Methods
    }
    return Slider;
    //#endregion Slider
