    ...
    constructor(owner, props) {
        ...
        if (owner) {
            ...
            core.private(this, {
                ...
                partialPosition: 0,
                buffer: [],
                mask: props.hasOwnProperty('mask') ? props.mask : String.EMPTY,
                maskDefinitions: { '9': '[0-9]', 'a': '[A-Za-z]', '*': '[A-Za-z0-9]' },
                blankSpace: props.hasOwnProperty('blankSpace') ? props.blankSpace : String.SPACE
            });
        }
    }
