(function () {
    ...
    if ($j.isHTMLRenderer()) {
        var FindReplaceDlgTpl = ["<div id='{internalId}' data-name='{name}' data-class='Window' class='Control Window csr_default FindReplaceDlg {theme} borderStyle-toolWindow' data-borderstyle='toolWindow' data-clientwidth='640' data-clientheight='480'>",
                               ...
                               "</div>",
                               "<!--[{\"text\":\"Sélection\",\"size\":13,\"checked\":false,\"enabled\":true,\"isHeader\":false,\"top\":0},",
                               "{\"text\":\"Document actif\",\"size\":13,\"checked\":false,\"enabled\":true,\"isHeader\":false,\"top\":16},",
                               "{\"text\":\"Tous les documents ouverts\",\"size\":13,\"checked\":false,\"enabled\":true,\"isHeader\":false,\"top\":32},",
                               "{\"text\":\"Projet actif\",\"size\":13,\"checked\":false,\"enabled\":true,\"isHeader\":false,\"top\":48},",
                               "{\"text\":\"Solution complète\",\"size\":13,\"checked\":false,\"enabled\":true,\"isHeader\":false,\"top\":64}]-->",
                               "</div>",
                               // SpeedButton NextBtn
