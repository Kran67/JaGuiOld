...
if (core.isHTMLRenderer) {
    ...
    const ColorDlgTpl = ['<jagui-gridlayout id="{internalId_grdLayout}" data-class="GridLayout" class="Control GridLayout">',
            '<properties>{ "name": "grdLayout", "align": "client", "margin": 15, "templateColumns": "231px 35px 135px 103px 30px", ',
            '"templateRows": "19px 24px 38px 25px 26px 44px 28px 29px", "columnGap": 0, "rowGap": 0 }</properties>',
        '<jagui-colorquad id="{internalId_clrQuad}" data-class="ColorQuad" class="Control ColorQuad hsl">',
            '<properties>{ "name": "clrQuad", "color": "blue", "format": "hsl", "colorBox": "clrBoxNewColor", "rowSpan": 8, ',
            '"column": 1, "row": 1, "width": 231, "height": 232 }</properties></jagui-colorquad>',
        '<jagui-colorpicker id="{internalId_clrPicker}" data-class="ColorPicker" class="Control ColorPicker">',
            '<properties>{ "name": "clrPicker", "colorQuad": "clrQuad", "color": "blue", "column": 2, "row": 1, "rowSpan": 8, "margin": { "left": 9, "right": 9 } }',
        ...
        '<jagui-slider id="{internalId_slrHue}" data-class="Slider" class="Control Slider {theme}"><properties>{"name": "slrHue", "values": [0,0], "max": 359, "margin": { "left": 15, "right": 15 }, "dataBindings": [{ "property": "firstValue", "destination": { "component": "txtbHue", "property": "text", "convertor": "intToStr" } }] }</properties></jagui-slider>',
        ...
        '<jagui-slider id="{internalId_slrSat}" data-class="Slider" class="Control Slider {theme}"><properties>{"name": "slrSat", "values": [0,0], "max": 100, "column": 2, "row": 2, "margin": { "left": 15, "right": 15 }, "dataBindings": [{ "property": "firstValue", "destination": { "component": "txtbSat", "property": "text", "convertor": "intToStr" } }] }</properties></jagui-slider>',
        ...
        '<jagui-slider id="{internalId_slrLight}" data-class="Slider" class="Control Slider {theme}"><properties>{"name": "slrLight", "values": [0,0], "column": 2, "row": 3, "max": 100, "margin": { "left": 15, "right": 15 }, "dataBindings": [{ "property": "firstValue", "destination": { "component": "txtbLight", "property": "text", "convertor": "intToStr" } }] }</properties></jagui-slider>',
        ...
        '<jagui-slider id="{internalId_slrHSVHue}" data-class="Slider" class="Control Slider {theme}"><properties>{"name": "slrHSVHue", "values": [0,0], "max": 359, "margin": { "left": 15, "right": 15 }, "dataBindings": [{ "property": "firstValue", "destination": { "component": "txtbHSVHue", "property": "text", "convertor": "intToStr" } }] }</properties></jagui-slider>',
        ...
        '<jagui-slider id="{internalId_slrHSVSat}" data-class="Slider" class="Control Slider {theme}"><properties>{"name": "slrHSVSat", "values": [0,0], "max": 100, "margin": { "left": 15, "right": 15 }, "column": 2, "row": 2, "dataBindings": [{ "property": "firstValue", "destination": { "component": "txtbHSVSat", "property": "text", "convertor": "intToStr" } }] }</properties></jagui-slider>',
        ...
        '<jagui-slider id="{internalId_slrValue}" data-class="Slider" class="Control Slider {theme}"><properties>{"name": "slrValue", "values": [0,0], "max": 100, "column": 2, "row": 3, "margin": { "left": 15, "right": 15 }, "dataBindings": [{ "property": "firstValue", "destination": { "component": "txtbValue", "property": "text", "convertor": "intToStr" } }] }</properties></jagui-slider>',
        ...
        '<jagui-alphaslider id="{internalId_slrOpacity}" data-class="AlphaSlider" class="Control Slider AlphaSlider {theme}"><properties>{"name": "slrOpacity", "values": [1,0], "margin": { "left": 15, "right": 15 }, "column": 2, "row": 1, "dataBindings": [{ "property": "firstValue", "destination": { "component": "txtbOpacity", "property": "text", "convertor": "floatToStr" } }] }</properties></jagui-alphaslider>',
