...
if (Core.isHTMLRenderer) {
    const PanelTpl = ["<jagui-panel id=\"{internalId}\" data-class=\"Panel\" class=\"Control Panel {theme}\"><properties>{ \"name\": \"{name}\", \"width\": 100, \"height\": 100 }</properties></jagui-panel>"].join(String.EMPTY);
