...
//#endregion Imports
//#region Button
Core.themes.lunametallic.Button.render = function (obj) {
    ...
    let pressedHovered, isBackOffset;
    ...
    pressedHovered = obj.isPressed?"PRESSED":String.EMPTY;
    isBackOffset = pressedHovered!==String.EMPTY||obj.isMouseOver;
    if (buttonTheme[`${pressedHovered}BACKCOLOR`]) {
        ...
        ctx.fillStyle = grad;
        ctx.fillRect(isBackOffset?buttonTheme.innerBorderSize+1:1, isBackOffset?buttonTheme.innerBorderSize+1:1, 
            width-2-(isBackOffset?buttonTheme.innerBorderSize * 2:0), height-2-(isBackOffset?buttonTheme.innerBorderSize * 2:0));
    }
...
//#endregion Button
//#region SpeedButton
Core.themes.lunametallic.SpeedButton.render = function (obj) {
    //#region Variables déclaration
    const ctx = Core.ctx;
    const width = obj.width;
    const height = obj.height;
